...
!        write(6,*) "noflag_occ time:",totaltime_noFlagOCC 
        ...
        write(6,*) "Runtime SE:", time_dyn
        write(6,*)
        write(6,*) "Answer-ch[1]:",achtemp(1)
        write(6,*) "Answer-ch[2]:",achtemp(2)
        write(6,*) "Answer-ch[3]:",achtemp(3)
        write(6,*)
        write(6,*) "Answer-sx[1]:",asxtemp(1)
        write(6,*) "Answer-sx[2]:",asxtemp(2)
        write(6,*) "Answer-sx[3]:",asxtemp(3)
        write(6,*)
        write(6,*) "Answer-Stat:",achstemp
!      endif
